...
interface GridLayout_Params {
    windowUtil?: WindowUtil | undefined;
    // 页面导航路由栈
    pageInfos?: NavPathStack;
}
import type { WindowUtil } from '../utils/WindowUtil';
import { GridView } from "@normalized:N&&&entry/src/main/ets/views/GridView&";
/**
 * 网格布局页面构建器函数
 *
 * 用于Navigation路由系统的页面构建，提供网格布局示例页面的创建入口
 */
export function GridBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new GridLayout(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/GridLayout.ets", line: 12, col: 3 });
...
export class GridLayout extends ViewPU {
    ...
    setInitiallyProvidedValue(params: GridLayout_Params) {
        if (params.pageInfos !== undefined) {
            this.pageInfos = params.pageInfos;
        }
    }
    updateStateVars(params: GridLayout_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/GridLayout.ets", line: 41, col: 7 });
                            ViewPU.create(componentCall);
                            let paramsLambda = () => {
                                return {
                                    mainWindowInfo: this.windowUtil?.mainWindowInfo,
            ...
            }, { moduleName: "entry", pagePath: "entry/src/main/ets/pages/GridLayout" });
...
(function () {
    if (typeof NavigationBuilderRegister === "function") {
        NavigationBuilderRegister("Grid", wrapBuilder(GridBuilder));
    }
})();
